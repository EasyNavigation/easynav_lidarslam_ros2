  ...
  broadcaster_(this)
{
  ...
  declare_parameter("tf_prefix", tf_prefix_);
  get_parameter("tf_prefix", tf_prefix_);

  global_frame_id_ = tf_prefix_ + global_frame_id_;
  robot_frame_id_ = tf_prefix_ + robot_frame_id_;
  odom_frame_id_ = tf_prefix_ + odom_frame_id_;
